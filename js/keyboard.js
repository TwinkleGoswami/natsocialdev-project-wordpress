...
(function() {
  ...
  this.VKI_kts = this.VKI_kt = "\u0a97\u0ac1\u0a9c\u0ab0\u0abe\u0aa4\u0ac0";  // Default keyboard layout
  this.VKI_langAdapt = true;  // Use lang attribute of input to select keyboard
  this.VKI_size = 2;  // Default keyboard size (1-5)
  this.VKI_sizeAdj = true;  // Allow user to adjust keyboard size
  this.VKI_clearPasswords = false;  // Clear password fields on focus
  this.VKI_imageURI = "http://natsocialdev.natrixsoftware.com/wp-content/themes/alone/images/keyboard.png";  // If empty string, use imageless mode
